...
then press **Accept** and **Finish**. Will be installed all the updates available, if required accept some request during the installing. In the end restart the IDE.
